...
当去看一些老接口的代码的时候, 有一种打开一个十年没动的箱子一样, 满满的一种历史尘土的味道. 会发现其中有一些写的很坑的地方, 但又不敢大改. 这也是我最近比较烦的地方, 新来的同事写的代码先不说写的好不好, 固执的不按我们新定的pandas报表逻辑走, 真的让人很头疼.   
...
2. 学了一下ipdb, pycharm的debug确实有一点慢, 如果只是简单调试的话, ipdb也是挺方便的(caiguai)   
<br>
### 给下周的自己一些建议
