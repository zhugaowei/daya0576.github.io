...
# 第二十五周 (04 September 2017)
<p></p> 
### 完成的工作总结:
1. **bug如潮水般涌来**: 虽然做了单元测试, 写代码时也提醒自己考虑周全, 但一提测, bug还是如潮水般涌来. 说实话, 自己还是要好好反思一下: 
    - 测试用例的覆盖率再提高一些? 但这又会大大增加单元测试的复杂度, 加大维护的难度, 所以我的观点还是, 测试用例不要搞得太复杂.   
    - 多参照测试编写好的测试用例, 还是不要盲目自信, 既然标准答案都有了, 为什么不好好利用起来呢?
2. **请假**: 请了三天假, 和女朋友出海去寻找one piece, 哈哈😆. 最近常常思考人生存在的意义,  说实话有些迷惘, 但总感觉还是要多出去走走, 看看这个奇妙的世界, 体验不一样的人生. 而不是渐渐安逸于平淡的生活, 沦陷为一只井底之蛙.
<p></p>
### 给下周的自己一些建议
1. **对于bug的反思**: 不要机械式的去为了解决bug而解决bug, 然后就万事大吉了. 要**多思考**为什么会出现这个bug, `如何在未来避免这种情况的再次发生`.    
<br>
<br>
---
<br>
...
<p></p> 
### 完成的工作总结:
1. **统统重写**: 继续配合前端框架升级, 重写所有旧的不合理的api. 但说实话有些迷惘, 尽力把代码写的再好(可读性, 合理的结构, robust, ), 又有谁在乎呢, 现实中只要页面上功能能用就行了.   
<p></p>
### 给下周的自己一些建议
1. **脸上写着IT!?!?**: 周末去打球的时候, 遇到个小哥打的还不错. 打完后互换了微信, 他也是做广告营销的, 然后他问我是做什么的. 我说是做IT的, 然后他大笑了三声后, 说道:"我就知道, **IT都写在你的脸上了**."  哈哈, 虽然自己有社交恐惧, 但还是要多出去交交朋友, 变成一个阳光宅男~~  
2. **算法导论:** 其实之前就提到今年把<算法导论>读完的计划, 但放弃了. 想了想还是要把这个计划执行起来(书的内容挺适合我的, 不会太简单也不会难), 所以做了这个计划: 
计划真的是个很神奇的东西, 说实话它并不能实质性的提高你的效率. 但它最大的功效就是把一个看似庞大的目标分割为无数个小目标, 然后让完成小目标的成就感, 一点一点地push你去抵达看似遥远的终点.
<br>
<br>
---
<br>
